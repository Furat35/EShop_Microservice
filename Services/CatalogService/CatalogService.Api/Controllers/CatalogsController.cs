...
namespace CatalogService.Api.Controllers
{
    ...
    public class CatalogsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Items([FromQuery] int pageSize = 10, [FromQuery] int pageIndex = 0, string ids = null)
        {
        ...
        [HttpGet("withname/{name:minlength(1)}")]
        ...
        [HttpGet("type/{catalogTypeId}/brand/{catalogBrandId:int?}")]
