            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form @submit.prevent="submitBasketCheckout" class="p-4 border rounded shadow-sm bg-light">
                        <h4 class="mb-4 text-center">Adres & Ödeme Bilgileri</h4>
                        ...
                        <div class="mb-4">
                            <label for="zip" class="form-label">Zip Kodu</label>
                            <input type="text" id="zip" class="form-control" v-model="basketCheckoutModel.zipCode"
                                required />
                        </div>

                        <h5 class="mb-3 mt-4">Kart Bilgileri</h5>
                        <div class="row mb-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="cardHolder" class="form-label">Ad Soyad</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="expiration" class="form-label">Geçerlilik Tarihi</label>
                        ...
                        <div class="mb-3">
                            <label for="cardTypeId" class="form-label">Kart Tipi (ID)</label>
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">Siparişi Tamamla</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        async submitBasketCheckout() {
            try {
                ...
                if (response.status === 204) {
                    ...
                    Toast.fire({
                        icon: "error",
                        title: `Sipariş verilirken hata oluştur. Tekrar deneyiniz!`
                    });
                }
