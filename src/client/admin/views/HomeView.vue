<template>
    ...
    <a class="scroll-to-top rounded" href="#mainPage" @click.prevent>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" @click="logout" data-dismiss="modal">Çıkış Yap</button>
                </div>
            </div>
        </div>
    </div>
...
<script lang="ts">
import { getUsername } from '@shared/helpers/userExtensions';
            ...
            if (sidebar) {
                ...
                if (sidebar.classList.contains('toggled')) {
                    ...
                    collapses.forEach(collapse => {
                        collapse.classList.remove('show'); // Bootstrap collapse hide
                    });
                }
            }
        },
